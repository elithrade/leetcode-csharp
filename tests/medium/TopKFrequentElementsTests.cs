...
public class TopKFrequentElementsTests
{
    ...
    public void LargeInputArray_StillReturnsCorrectResult()
    {
        ...
        Console.WriteLine(
            $"Execution Time for solving array of 1700 numbers O(n): {stopwatch.GetElapsedNanoseconds()} ns"
        );
        ...
        Console.WriteLine(
            $"Execution Time for solving array of 1700 numbers O(n*log*k): {stopwatch.GetElapsedNanoseconds()} ns"
        );
    }
